...
apt-get update # Several failures but go ahead and ignore them for now
apt-get install -y git docker-ce
/usr/sbin/usermod -aG docker ${USER} # THis fails I do not know why
...
# Ensure docker-compose.yml is provided. I used sftp for now
...
#  mkdir /repo/ADCIRCSupportTools/deploy/irods
# PLus a bunch of others like ingress, nfsrods, etc.
